$(function () {
  ...
  if ($body.attr("data-preloader") === "1") {
    ...
    $body.append(
      $(
        "<div class='preloader preloader-8'><div><h6 class='heading-uppercase'>Loading</h6><span class='spinner'></span></div></div>"
      )
    );
  } else if ($body.attr("data-preloader") === "9") {
    $body.append(
      $(
        "<div class='preloader preloader-9'><div><span class='spinner'><span></div></div>"
      )
    );
  }
